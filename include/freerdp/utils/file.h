...
FREERDP_API BOOL freerdp_check_file_exists(const char* file);
FREERDP_API BOOL freerdp_check_file_exists_and_delete(const char* file);
// void freerdp_remove_file(const char *fName);
FREERDP_API void freerdp_remove_file(const char *fName);
